...
<div class="d-flex justify-content-center">
  <div class="row w-75">
    <div class="col-5 offset-1">
      @if($product->image !== "")
      <img src="{{asset($product->image)}}" class="w-100 img-thumbnail">
      @else
      <img src="{{asset('img/dummy.png')}}" class="1-100 img-thumbnail">
      @endif    </div>
    <div class="col">
    ...
    <div class="offset-1 col-11">
      ...
      @if ($product->reviews->avg('score') !==null)
      <label class="star-rating" data-rate="{{round($product->reviews->avg('score')*2)/2}}"></label>
      <label>{{round($product->reviews->avg('score'),1)}}</label><br>
    @endif
