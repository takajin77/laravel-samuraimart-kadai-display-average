          ...
          <div class="row">
            <div class="col-12">
              <p class="samuraimart-product-label mt-2">
                ...
                @if ($recommend_product->reviews->avg('score') !==null)
                  <label class="star-rating" data-rate="{{round($recommend_product->reviews->avg('score')*2)/2}}"></label>
                  <label class="samuraimart-product-label mt-2">{{round($recommend_product->reviews->avg('score'),1)}}</label><br>
          ...
          <div class="row">
            <div class="col-12">
              <p class="samuraimart-product-label mt-2">
                ...
                @if ($recently_product->reviews->avg('score') !==null)
                  <label class="star-rating" data-rate="{{round($recently_product->reviews->avg('score')*2)/2}}"></label>
                  <label>{{round($recently_product->reviews->avg('score'),1)}}</label><br>
                @endif
