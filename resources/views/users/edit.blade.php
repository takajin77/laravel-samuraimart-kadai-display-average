    ...
    <div class="col-md-5">
      ...
      <form action="{{route('mypage')}}" method="POST">
        ...
        <div class="form-group">
          ...
          <div class="collaspe show editUserName">
        ...
        <div class="form-group">
          ...
          <div class="collapse show edidUserPhone">
      ...
      <div class="d-flex justify-content-start">
        <form method="POST" action="{{route('mypage.destroy')}}">
          ...
          <div class="btn dashiboard-delete-link" data-bs-toggle="modal" data-bs-target="#delete-user-confirm-modal">退会する</div>

          <div class="modal fade" id="delete-user-confirm-modal" data-backdrop="static" data-keybord="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true" >
