    ...
    <div class="row">
      @foreach ($favorite_products as $favorite_product)
        <div class="col-md-7 mt-2">
          <div class="d-inline-flex">
            <a href="{{route('products.show',$favorite_product->id)}}" class="w-25">
              ...
              <img src="{{asset($favorite_product->image)}}" class="w-100 img-thumbnail">
              @else
              <img src="{{asset('img/dummy.png')}}" class="w-100 img-thumbnail">
              @endif            </a>
        ...
        <div class="col-md-3 d-flex align-items-center justify-content-end">
          <form action="{{route('carts.store')}}" method="POST" class="m3 align-items-end">
            @csrf
            ...
            <input type="hidden" name="cariage" value="{{$favorite_product->carriage_flag}}">
